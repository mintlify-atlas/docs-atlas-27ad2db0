...
description: "Invoke the PDF Generator Lambda locally with the Serverless CLI, and validate the live API Gateway endpoint with curl after deploying to AWS."
---
