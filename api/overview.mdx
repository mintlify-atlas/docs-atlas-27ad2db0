...
description: "Overview of the AWS Lambda PDF Generator REST API: two endpoints for PDF generation and service metadata, JSON request bodies, and binary PDF responses."
---
